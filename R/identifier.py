# Copyright (c) 2021 Ferretti lab- Virginia Tech Fish and Wildlife
"""
Main script for evaluating the probability of shark presence in images.
See our method paper:
Jenrette J, Liu ZY-C, Chimote P, Hastie T, Fox E, Ferretti F. Shark Detector: Classifying 
and detecting sharks with machine learning. 2021 (In prep).

detector.py: CNN architecture, binary shark identification  
For questions, email: jjeremy1@vt.edu 
"""
# -------------------------------------------------------------------------------------
