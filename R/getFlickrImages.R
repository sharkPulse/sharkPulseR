...
#	photos <- flickr.photos.search(api_key = api_key, geoBox = geoBox, text = text, .allpages = TRUE, extras = c("date_upload","last_update"))
    # if I include extrax all the other metadada disappear
